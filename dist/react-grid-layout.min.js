            ...
            (e.prototype.componentDidMount = function() {
              ...
              (this.props.dragApiRef.value = {
                dragIn: function(n) {
                  ...
                  var l = t.state.layout,
                    c = t.props,
                    f = c.margin,
                    p = c.containerPadding,
                    d = (0, m.calcXY)(u.top, u.left, {
                  ...
                  if (t.state.activeDrag)
                    t.onDrag(r, h, y, { e: s, node: i, newPosition: u });
                  else {
                    var g = { i: r, w: o, h: a, x: h, y: y };
                    t.setState({
                      oldDragItem: g,
                      oldLayout: l,
                      layout: [].concat(t.state.layout, [g]),
                      activeDrag: g
                    }),
                      t.props.onDragStart(l, g, g, null, s, i);
                  }
                },
                dragOut: function() {
                  if (e) {
