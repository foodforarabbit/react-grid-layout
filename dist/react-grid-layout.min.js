  ...
  return (function(t) {
    ...
    function(t, e, n) {
      ...
      (e.bottom = o),
        ...
        (e.synchronizeLayoutWithChildren = O),
        (e.validateLayout = D),
    ...
    function(t, e, n) {
      (function(t, n) {
        ...
        function y(t) {
          var e = this.__data__;
          return Re ? void 0 !== e[t] : ie.call(e, t);
        }
        function g(t, e) {
          var n = this.__data__;
          return (
            (this.size += this.has(t) ? 0 : 1),
            (n[t] = Re && void 0 === e ? vt : e),
            this
          );
        }
        function m(t) {
        ...
        function Y(t, e, n, r, o, a) {
          ...
          if (p && !c)
            return (
              a || (a = new P()),
              i || Ne(t) ? V(t, e, n, r, o, a) : $(t, e, u, n, r, o, a)
            );
          if (!(n & bt)) {
        ...
        (qt["[object Float32Array]"] = qt["[object Float64Array]"] = qt[
          ...
          (qt[St] = qt[_t] = qt[It] = qt[Ot] = qt[Bt] = qt[Dt] = qt[Et] = qt[
            jt
          ] = qt[zt] = qt[Ct] = qt[kt] = qt[Lt] = qt[At] = qt[Nt] = qt[
            "[object WeakMap]"
          ] = !1);
    ...
    function(t, e, n) {
      ...
      var u =
        ...
        w = (function(t) {
          function e(n, r) {
            a(this, e);
            var o = i(this, t.call(this, n, r));
            return (
              x.call(o),
              (0, m.autoBindHandlers)(o, [
                "onDragStart",
                "onDrag",
                "onDragStop",
                "onResizeStart",
          ...
          return (
              ...
              (this.props.dragApiRef.value = {
                dragIn: function(n) {
                  var r = n.i,
                    ...
                    l = n.event,
                    c = n.position,
                    f = o(n, ["i", "w", "h", "node", "event", "position"]);
                  e = { i: r, w: a, h: i, node: s };
                  var p = t.state.layout,
                    d = t.props,
                    h = d.margin,
                    y = d.containerPadding,
                    g = (0, v.calcXY)(c.top, c.left, {
                      containerWidth: t.props.width,
                      cols: t.props.cols,
                      margin: h,
                      containerPadding: y || h,
                  ...
                  if (t.state.activeDrag)
                    t.onDrag(r, m, b, { e: l, node: s, newPosition: c });
                  else {
                    var w = u({ i: r, w: a, h: i, x: m, y: b }, f);
                    t.setState({
                      oldDragItem: w,
                      oldLayout: p,
                      layout: [].concat(t.state.layout, [w]),
                      activeDrag: w
                    }),
                      t.props.onDragStart(p, w, w, null, l, s);
                  }
                },
                dragOut: function() {
                  if (e) {
            ...
            (e.prototype.componentWillReceiveProps = function(t) {
              ...
              if (
                ...
                t.compactType === this.props.compactType
                  ? (0, m.childrenEqual)(this.props.children, t.children) ||
                    (e = this.state.layout)
                  : (e = t.layout),
                e)
              ) {
                var n = (0, m.synchronizeLayoutWithChildren)(
                    e,
                    t.children,
                    t.cols,
                    this.compactType(t)
            ...
            (e.prototype.containerHeight = function() {
              if (this.props.autoSize) {
                var t = (0, m.bottom)(this.state.layout),
            ...
            (e.prototype.onDragStart = function(t, e, n, r) {
              var o = r.e,
                a = r.node,
                i = this.state.layout,
                s = (0, m.getLayoutItem)(i, t);
              if (s)
                return (
                  this.setState({
                    oldDragItem: (0, m.cloneLayoutItem)(s),
            ...
            (e.prototype.onDrag = function(t, e, n, r) {
              ...
              if (l) {
                ...
                (s = (0, m.moveElement)(
                  ...
                  this.setState({
                    layout: (0, m.compact)(s, this.compactType(), u),
                    activeDrag: c
                  });
              }
            }),
            (e.prototype.onDragStop = function(t, e, n, r) {
              ...
              if (f) {
                ...
                var p = (0, m.compact)(s, this.compactType(), l),
            ...
            (e.prototype.onResizeStart = function(t, e, n, r) {
              ...
              s &&
                (this.setState({
                  oldResizeItem: (0, m.cloneLayoutItem)(s),
                  oldLayout: this.state.layout
                }),
            ...
            (e.prototype.onResize = function(t, e, n, r) {
              var o = r.e,
                ...
                d = (0, m.getLayoutItem)(s, t);
              if (
                d &&
                (!p || !(0, m.getFirstCollision)(s, u({}, d, { w: e, h: n })))
              ) {
                (d.w = e), (d.h = n);
                var h = { w: e, h: n, x: d.x, y: d.y, static: !0, i: t };
                this.props.onResize(s, l, d, h, o, a),
                  this.setState({
                    layout: (0, m.compact)(s, this.compactType(), f),
                    activeDrag: h
                  });
              }
            }),
            (e.prototype.onResizeStop = function(t, e, n, r) {
              var o = r.e,
                ...
                u = i.oldResizeItem,
                l = this.props.cols,
                c = (0, m.getLayoutItem)(s, t);
              this.props.onResizeStop(s, u, c, null, o, a);
              var f = (0, m.compact)(s, this.compactType(), l),
            ...
            (e.prototype.processGridItem = function(t) {
              if (t.key) {
                var e = (0, m.getLayoutItem)(this.state.layout, String(t.key));
                if (!e) return null;
                var n = this.props,
                  r = n.width,
                  o = n.cols,
                  ...
                  g = Boolean(
                    !e.static && l && (e.isDraggable || null == e.isDraggable)
                  ),
                  v = Boolean(
            ...
            (e.prototype.render = function() {
              var t = this,
                ...
                a = u({ height: this.containerHeight() }, r);
              return c.default.createElement(
                "div",
                { className: o, style: a },
                c.default.Children.map(this.props.children, function(e) {
      ...
      (w.displayName = "ReactGridLayout"),
        (w.propTypes = {
          ...
          layout: function(t) {
            var e = t.layout;
            void 0 !== e && (0, m.validateLayout)(e, "layout");
          },
          ...
          children: function(t, e) {
            var n = t[e],
              r = {};
            c.default.Children.forEach(n, function(t) {
              if (r[t.key])
                throw new Error(
                  'Duplicate child key "' +
                    t.key +
        ...
        (w.defaultProps = {
          ...
          preventCollision: !1,
          dragApiRef: (0, m.createDragApiRef)(),
          onLayoutChange: m.noop,
          onDragStart: m.noop,
          onDrag: m.noop,
          onDragStop: m.noop,
          onResizeStart: m.noop,
          onResize: m.noop,
          onResizeStop: m.noop
        });
      var x = function() {
        this.state = {
          activeDrag: null,
          layout: (0, m.synchronizeLayoutWithChildren)(
            this.props.layout,
            this.props.children,
            this.props.cols,
            this.compactType()
        ...
        return (function(t) {
          ...
          function(t, e, n) {
            ...
            function d(t) {
              ...
              return r(
                {},
                (0, R.browserPrefixToKey)("transform", O.default),
                "translate(" + e + "px," + n + "px)"
              );
            }
            function h(t) {
                ...
                function e(t) {
                  ...
                  return (
                    (n.onDragStart = function(t, e) {
                      if (
                        ((0, O.default)("Draggable: onDragStart: %j", e),
                        !1 ===
                    ...
                    (n.onDrag = function(t, e) {
                      ...
                      (0, O.default)("Draggable: onDrag: %j", e);
                    ...
                    (n.onDragStop = function(t, e) {
                      ...
                      if (
                        ...
                        return !1;
                      (0, O.default)("Draggable: onDragStop: %j", e);
